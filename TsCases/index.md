...
С примитивами мы разобрались, теперь я хочу показать еще одну возможность которой часто пользуюсь - создание нового типа на основе существующего. В С# мы обычно расширяем типы, а вот в TS мы можем создавать новые типы на основе уже существующих:
